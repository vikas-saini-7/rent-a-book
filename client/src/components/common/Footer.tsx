    ...
    <footer className="w-full border-t border-border bg-bg-card">
      <div className="max-w-7xl mx-auto px-6 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 md:gap-12 mb-12">
          {/* Brand Column */}
          <div className="md:col-span-2 max-w-[320px]">
            ...
            <p className="text-text-secondary text-sm leading-relaxed">
              Your trusted platform for renting books. Save money, save space,
              and enjoy reading.
            </p>
          </div>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-text-muted text-sm">
            © {new Date().getFullYear()} RentABook. All rights reserved.
          </p>
